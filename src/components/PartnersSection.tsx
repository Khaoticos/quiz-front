import { Star, Users, MapPin, Gamepad2, Trophy, Award, Clock } from "lucide-react";
...
const PartnersSection = () => {
  return (
    <>
      {/* Estabelecimentos Parceiros Section */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center justify-center gap-2 mb-2">
                <span className="text-3xl md:text-4xl font-bold" style={{ color: '#FF6B35' }}>+12k</span>
                <Gamepad2 size={24} style={{ color: '#FF6B35' }} />
              </div>
              <div className="text-sm text-gray-700">Jogos realizados</div>
            </div>
            <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center justify-center gap-2 mb-2">
                <span className="text-3xl md:text-4xl font-bold" style={{ color: '#0061E0' }}>+150</span>
                <Trophy size={24} style={{ color: '#0061E0' }} />
              </div>
              <div className="text-sm text-gray-700">Bares parceiros</div>
            </div>
            <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center justify-center gap-2 mb-2">
                <span className="text-3xl md:text-4xl font-bold" style={{ color: '#0061E0' }}>98%</span>
                <Award size={24} style={{ color: '#0061E0' }} />
              </div>
              <div className="text-sm text-gray-700">Satisfação</div>
            </div>
            <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center justify-center gap-2 mb-2">
                <span className="text-3xl md:text-4xl font-bold" style={{ color: '#FF6B35' }}>24h</span>
                <Clock size={24} style={{ color: '#FF6B35' }} />
              </div>
              <div className="text-sm text-gray-700">Suporte ativo</div>
            </div>
          </div>
        </div>
      </section>
              ...
              <div key={index} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="flex mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 fill-current" style={{ color: '#FF6B35' }} />
                  ))}
                </div>
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mr-4 font-bold text-white text-lg" style={{ backgroundColor: '#FF6B35' }}>
